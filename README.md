Sonic Craft Hub is a sleek, responsive landing page based on a Figma design, built using semantic HTML, modular SCSS with BEM, and just a touch of vanilla JavaScript.
